...
public class Upsell_Crossell_flow extends TestBase{

	@DataProvider
	public Object[][] Data() throws IOException {
		return getData(ConstantUtility.input_excel, ConstantUtility.upsell_crosssell_sheet);
	}
	...
	public void aftersuite() throws AddressException, MessagingException, IOException {
		UPSELL_CROSSSELL_USER_END_CONFIGURATION(ConstantUtility.upsell_crossell_mail_attachment_filename,ConstantUtility.Upsell_crossell_mail_subject,
